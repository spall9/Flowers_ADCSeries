namespace EasyEvade_Loader
{
    ...
    internal class Program
    {
        ...
        private static readonly string dllPath = Path.Combine(getAppDataPath, @"EloBuddy\Addons\Libraries\MoonEvade.dll");
        ...
        private static void Main(string[] eventArgs)
        {
            Loading.OnLoadingComplete += Args =>
            {
                ...
                var prdll = Properties.Resources.EasyEvade;
                ...
                var main = dllpath.GetType("EasyEvade.MyLoader").GetMethod("Init");
